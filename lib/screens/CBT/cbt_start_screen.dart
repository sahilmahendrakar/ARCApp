            ...
            IconButton(
              ...
              onPressed: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => CBTHistory()));
              },
              tooltip: 'View summaries of your past submissions',
            ),
          ]),
      body: Container(
        ...
        child: SafeArea(
          child: Column(children: [
            //Text('Cognitive Behavioral Therapy', textAlign: TextAlign.center,style: TextStyle( color: pureWhite, fontSize: getProportionateScreenWidth(20), fontWeight: FontWeight.bold)),
            ...
            Text(
                'A lot of the negative, stressful thoughts that pop into our heads are not realistic. Thankfully, we ' +
